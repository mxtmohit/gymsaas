...
import { ArrowRight, QrCode, ShieldCheck, TrendingUp } from "lucide-react";
    ...
    <div className="relative min-h-screen bg-brutal-bg text-black overflow-hidden font-sans">
      ...
      <section className="relative pt-16 pb-20 sm:pt-24 sm:pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center space-y-8">
        ...
        <p className="text-sm sm:text-lg lg:text-xl font-bold text-slate-800 max-w-2xl mx-auto leading-relaxed pt-2">
          Let members join, select subscriptions, and submit UPI payment
          verification screenshots directly from their phone. Standardize
          billing operations with flat analytics dashboards.
        </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-2">
            ...
            <p className="text-slate-650 font-bold max-w-xl mx-auto text-xs sm:text-sm">
              Say goodbye to sheets and manuals. Track billing and active
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="neo-card p-8 flex flex-col items-start gap-4">
              ...
              <p className="text-slate-700 text-xs sm:text-sm font-medium leading-relaxed">
                Get a custom subdomain for your gym (e.g.{" "}
                <span className="font-bold">power.mygymsaas.com</span>). Members
                scan the printed QR at the counter to join instantly.
              </p>
            </div>
            ...
            <div className="neo-card p-8 flex flex-col items-start gap-4">
              ...
              <p className="text-slate-700 text-xs sm:text-sm font-medium leading-relaxed">
                Members select plans, pay to your UPI ID, and upload UTR
                screenshots. Review submissions on your clean payment
            ...
            <div className="neo-card p-8 flex flex-col items-start gap-4">
              ...
              <p className="text-slate-700 text-xs sm:text-sm font-medium leading-relaxed">
                No complex calculations. View total registrations, active
                members, revenue totals, and clean month-on-month trend charts.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 border-t-3 border-black bg-brutal-bg px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="neo-card bg-white p-6 relative">
            ...
            <h4 className="text-lg font-black uppercase mt-2 mb-2">
              Configure Gym
            </h4>
            <p className="text-slate-700 text-xs font-semibold leading-relaxed">
              Create your profile, configure membership plans (Monthly, Yearly),
              and upload your merchant UPI ID and QR code.
            </p>
          </div>
          ...
          <div className="neo-card bg-white p-6 relative">
            ...
            <p className="text-slate-700 text-xs font-semibold leading-relaxed">
              Members scan the printed counter QR code, select their plan, make
              direct UPI payments, and upload proof details.
            </p>
          </div>
          ...
          <div className="neo-card bg-white p-6 relative">
            ...
            <p className="text-slate-700 text-xs font-semibold leading-relaxed">
              You verify the UTR and screenshot inside your dashboard and click
              Approve. The system automatically computes and activates their
              membership.
            </p>
          </div>
        </div>
      ...
      <footer className="border-t-3 border-black bg-white py-10">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4 font-bold text-xs sm:text-sm text-black">
          ...
          <p>
            © {new Date().getFullYear()} FlexFlow GymSaaS. Minimal, Bold,
            Automated.
          </p>
